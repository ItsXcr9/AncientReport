...
CREATE DATABASE IF NOT EXISTS AncientReport;
USE AncientReport;
...
-- Materialized view to auto-populate hourly aggregations
...
-- 5-minute aggregation table for granular dashboards
...
-- View for quick server health overview
